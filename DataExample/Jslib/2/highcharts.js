...
(function() {
    ...
    function v(a, b) { return parseInt(a, b || 10); }
    ...
    function Ca(a) { return Object.prototype.toString.call(a) === "[object Array]"; }

    function ua(a) { return typeof a === "number"; }

    function na(a) { return N.log(a) / N.LN10; }

    function da(a) { return N.pow(10, a); }
    ...
    function s(a) { return a !== w && a !== null; }
    ...
    function Na(a, b, c, d) {
        var e = P.lang, f = a;
        b === -1 ? (b = (a || 0).toString(), a = b.indexOf(".") >
            -1 ? b.split(".")[1].length : 0) : a = isNaN(b = R(b)) ? 2 : b;
    ...
    function va(a, b) { return Array((b || 2) + 1 - String(a).length).join(0) + a; }
    ...
    function Ab(a, b, c, d) {
        ...
        if (s(b)) {
            ...
            for (var d = i.getTime(), m = i[Xa](), l = i[Qa](), i = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;)
                e.push(d), j === A[wa] ? d = Za(h + b * k, 0) : j === A[Pa] ?
    ...
    function Fb() { this.symbol = this.color = 0; }
    ...
    function Ga(a, b) { for (var c in a) a[c] && a[c] !== b && a[c].destroy && a[c].destroy(), delete a[c]; }
    ...
    function ia(a) { return parseFloat(a.toPrecision(14)); }

    function Ha(a, b) { ya = o(a, b.animation); }
    ...
    function ab() { this.init.apply(this, arguments); }

    function pb() { this.init.apply(this, arguments); }

    function qb(a, b) { this.init(a, b); }

    function rb(a, b) { this.init(a, b); }

    function sb() { this.init.apply(this, arguments); }
    ...
    Fb.prototype = { wrapColor: function(a) { if (this.color >= a) this.color = 0; }, wrapSymbol: function(a) { if (this.symbol >= a) this.symbol = 0; } };
    A = function() {
            ...
            init: function(b) {
                ...
                this.each = Array.prototype.forEach ? function(a, b) {
                    return Array.prototype.forEach.call(a,
                        b);
                } : function(a, b) { for (var c = 0, d = a.length; c < d; c++) if (b.call(a[c], a[c], c, a) === !1) return c; };
    ...
    P = {
        ...
        global: { useUTC: !0, canvasToolsURL: "http://code.highcharts.com/3.0.0/modules/canvas-tools.js", VMLRadialGradientURL: "http://code.highcharts.com/3.0.0/gfx/vml-radial-gradient.png" },
        chart: {
            borderColor: "#4572A7",
            borderRadius: 5,
        ...
        plotOptions: {
            line: {
                ...
                point: { events: {} },
                dataLabels: x(L, { enabled: !1, formatter: function() { return this.y; }, verticalAlign: "bottom", y: 0 }),
                cropThreshold: 300,
                pointRange: 0,
                showInLegend: !0,
    ...
    var la = function(a) {
        ...
        return {
            ...
            brighten: function(a) {
                if (d) n(d, function(b) { b.brighten(a); });
                else if (ua(a) && a !== 0) {
                    var c;
    ...
    ra.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (fa(a)) c = a, h === "circle" ? c = { x: "cx", y: "cy" }[c] || c : c === "strokeWidth" && (c = "stroke-width"), r = C(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (r = parseFloat(r));
            else {
                for (c in a)
                    if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                        ...
                        else if (h === "rect" && c === "r") C(g, { rx: d, ry: d }), j = !0;
        ...
        symbolAttr: function(a) {
            ...
            n("x,y,r,start,end,width,height,innerR,anchorX,anchorY".split(","),
                function(c) { b[c] = o(a[c], b[c]); });
            b.attr({ d: b.renderer.symbols[b.symbolName](b.x, b.y, b.width, b.height, b) });
        },
        clip: function(a) { return this.attr("clip-path", a ? "url(" + this.renderer.url + "#" + a.id + ")" : O); },
        ...
        css: function(a) {
            var b = this.element, b = a && a.width && b.nodeName.toLowerCase() === "text", c, d = "", e = function(a, b) { return "-" + b.toLowerCase(); };
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (c || d) M(b, { marginLeft: c, marginTop: d }), j && n(j, function(a) { M(a, { marginLeft: c + 1, marginTop: d + 1 }); });
        ...
        add: function(a) {
            ...
            if (c.handleZ)
                for (c = 0; c < e.length; c++)
                    if (a = e[c], b = C(a, "zIndex"), a !== f && (v(b) > g || !s(g) && s(b))) {
                        d.insertBefore(f, a);
                        h = !0;
                        break;
                    }
    ...
    var Ba = function() { this.init.apply(this, arguments); };
    Ba.prototype = {
        Element: ra,
        ...
        button: function(a, b, c, d, e, f, g) {
            ...
            p = g.style;
            delete g.style;
            J(h.element, "mouseenter", function() { h.attr(f).css(l); });
        ...
        symbol: function(a, b, c, d, e, f) {
            ...
            }, j = a.match(i)[1], a = Lb[j], g = this.image(j).attr({ x: b, y: c }), a ? k(g, a) : (g.attr({ width: 0, height: 0 }), U("img", { onload: function() { k(g, Lb[j] = [this.width, this.height]); }, src: j })));
            return g;
        },
        symbols: {
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            ...
            function m(a, b) { B ? B.attr(a, b) : v[a] = b; }
            ...
            return u(r, {
                css: function(a) {
                    if (a) {
                        var b = {}, a = x(a);
                        n("fontSize,fontWeight,fontFamily,color,lineHeight,width".split(","), function(c) { a[c] !== w && (b[c] = a[c], delete a[c]); });
                        o.css(b);
                    }
                    return A.call(r, a);
                },
    ...
    if (!Z && !$) {
        Highcharts.VMLElement = K = {
                ...
                if (fa(a)) c = a, r = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c];
                    ...
                    for (c in a)
                        if (d = a[c], l = !1, e = p[c] && p[c].call(this, d, c), e !== !1 && d !== null) {
                            ...
                            else if (ka(c, ["x", "y", "width", "height"]) !== -1)
                                this[c] = d, c === "x" || c === "y" ? c = {
                                    x: "left",
                                    y: "top"
            ...
            clip: function(a) {
                var b = this, c;
                a ? (c = a.members, ga(c, b), c.push(b), b.destroyClip = function() { ga(c, b); }, a = a.getCSS(b)) : (b.destroyClip && b.destroyClip(),
        ...
        var ma = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, p = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, q = 'angle="' + (90 - N.atan((l - a) / (p - c)) * 180 / Ja) + '"', w();
                        else {
        ...
        Highcharts.VMLRenderer = K = function() { this.init.apply(this, arguments); };
        K.prototype = x(Ba.prototype, ma);
        Sa = K;
    }
    var Qb;
    if ($)
        Highcharts.CanVGRenderer = K = function() { sa = "http://www.w3.org/1999/xhtml"; }, K.prototype.symbols = {}, Qb = function() {
    ...
    Ia.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (i && !isNaN(H))
                i.xy = Q = this.getLabelPosition(H, Q, i, g, k, v, a, t), this.isFirst && !o(e.showFirstLabel,
    ...
    ob.prototype = {
        render: function() {
            ...
            if (s(y)) d.zIndex = y;
            if (p) r ? p.animate({ d: r }, null, p.onGetPath) : (p.hide(), p.onGetPath = function() { p.show(); });
            else if (r && r.length && (a.svgElem = p = t.path(r).attr(d).add(), I))
                for (n in e = function(b) { p.on(b, function(c) { I[b].apply(a, [c]); }); },
                I) e(n);
    ...
    ab.prototype = {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: { enabled: !1, formatter: function() { return this.total; }, style: L.style }
        },
                ...
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        for (h = 0; h < u; h++) {
                            ...
                            if (I !== null && I !== w && (!a.isLog || I > 0))
                                if (A && (I = g.modifyValue(I)), g.getExtremesFromAll || C || (j[h + 1] || y) >= z.min && (j[h - 1] || y) <= z.max)
                                    if (y = I.length) for (; y--;) I[y] !== null && (v[x++] = I[y]);
                                    else v[x++] = I;
                        }
                        if (!a.usePercentage && v.length)
                            g.dataMin = k = Fa(v), g.dataMax = g = pa(v), a.dataMin = F(o(a.dataMin,
        ...
        setTickPositions: function(a) {
            ...
            b.adjustForMinRange();
            if (!r && !b.usePercentage &&
                !h && s(b.min) && s(b.max) && (c = b.max - b.min)) {
            ...
            if (!i)
                i = f ? (b.getNonLinearTimeTicks || Ab)(yb(b.tickInterval,
        ...
        getOffset: function() {
            ...
            if (b || a.isLinked)
                n(e, function(b) {
                    f[b] ? f[b].addLabel() :
                        f[b] = new Ia(a, b);
                }), n(e, function(a) { if (h === 0 || h === 2 || { 1: "left", 3: "right" }[h] === r.align) t = q(f[a].getLabelSize(), t); }), a.staggerLines && (t += (a.staggerLines - 1) * 16);
            ...
            if (p && p.text && p.enabled !== !1) {
                ...
                if (j)
                    k = a.axisTitle.getBBox()[g ? "height" : "width"], l = o(p.margin,
                        g ? 5 : 10), m = p.offset;
        ...
        render: function() {
            ...
            if (a.hasData || f)
                if (n([j, k, m], function(a) { for (var b in a) a[b].isActive = !1; }), a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function(b) {
                ...
                }), r && a.min === 0 && (j[-1] || (j[-1] = new Ia(a, -1, null, !0)), j[-1].render(-1))), p && n(g, function(b, c) { if (c % 2 === 0 && b < a.max) m[b] || (m[b] = new ob(a)), u = b + r, v = g[c + 1] !== w ? g[c + 1] + r : a.max, m[b].options = { from: e ? da(u) : u, to: e ? da(v) : v, color: p }, m[b].render(), m[b].isActive = !0; }), !a._addedPlotLB) n((d.plotLines || []).concat(d.plotBands || []), function(b) { a.addPlotBandOrLine(b); }), a._addedPlotLB = !0;
            n([j,
                    k, m], function(a) {
                        var c, d, e = [], f = ya ? ya.duration || 500 : 0, g = function() { for (d = e.length; d--;) a[e[d]] && !a[e[d]].isActive && (a[e[d]].destroy(), delete a[e[d]]); };
        ...
        destroy: function() {
            ...
            n([a.ticks, a.minorTicks, a.alternateBands, a.plotLinesAndBands], function(a) { Ga(a); });
    ...
    pb.prototype = {
        ...
        move: function(a, b, c, d) {
            ...
            e.label.attr(f);
            if (g && (R(a - f.x) > 1 || R(b - f.y) > 1)) clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function() { e && e.move(a, b, c, d); }, 32);
        },
        hide: function() {
            var a = this, b;
            if (!this.isHidden)
                b = this.chart.hoverPoints, this.hideTimer = setTimeout(function() {
                    a.label.fadeOut();
                    a.isHidden = !0;
                }, o(this.options.hideDelay, 500)), b && n(b, function(a) { a.setState(); }), this.chart.hoverPoints = null;
        },
        ...
        refresh: function(a, b) {
            ...
            f = g[0];
            g = g[1];
            h && (!a.series || !a.series.noSharedTooltip) ? (c.hoverPoints = a, i && n(i, function(a) { a.setState(); }), n(a, function(a) {
                a.setState("hover");
            ...
            if (l) {
                ...
                for (d = l.length; d--;)
                    if (e = a.series[d ? "yAxis" : "xAxis"], l[d] && e)
                        if (e = e.getPlotLinePath(d ? o(a.stackY, a.y) : a.x, 1), this.crosshairs[d])
    ...
    qb.prototype = {
        ...
        getCoordinates: function(a) {
            var b = { xAxis: [], yAxis: [] };
            n(this.chart.axes, function(c) { b[c.isXAxis ? "xAxis" : "yAxis"].push({ axis: c, value: c.toValue(a[c.horiz ? "chartX" : "chartY"]) }); });
            return b;
        },
        getIndex: function(a) {
            var b = this.chart;
        ...
        pinch: function(a) {
            ...
            Ka(e, function(a) { return b.normalize(a); });
            if (a.type ===
                "touchstart")
                n(e, function(a, b) { d[b] = { chartX: a.chartX, chartY: a.chartY }; }), f.x = [d[0].chartX, d[1] && d[1].chartX], f.y = [d[0].chartY, d[1] && d[1].chartY], n(c.axes, function(a) {
                    if (a.zoomEnabled) {
        ...
        drop: function(a) {
            ...
            if (this.selectionMarker) {
                ...
                if (this.hasDragged || c)
                    ...
                    }), h && G(b, "selection", d, function(a) { b.zoom(u(a, c ? { animation: !1 } : null)); });
        ...
        onContainerClick: function(a) {
            ...
            a.cancelBubble = !0;
            if (!b.cancelClick)
                c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, u(c, { pageX: g.left + d + (f ? b.plotWidth - i : h), pageY: g.top + e + (f ? b.plotHeight - h : i) }), G(c.series, "click", u(a, { point: c })), c.firePointEvent("click",
    ...
    rb.prototype = {
        init: function(a, b) {
            ...
            this.options = b;
            if (b.enabled)
                c.baseline = v(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = x(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight =
        ...
        positionCheckboxes: function(a) {
            ...
            if (b)
                c = b.translateY, n(this.allItems,
                    function(e) {
                        var f = e.checkbox, g;
        ...
        renderItem: function(a) {
            ...
            if (!n && (a.legendGroup = d.g("legend-item").attr({ zIndex: 1 }).add(b.scrollGroup), t.drawLegendSymbol(b, a), a.legendItem = n = d.text(e.labelFormat ? Ea(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, v).css(x(a.visible ?
                ...
                }), b.colorizeItem(a, a.visible), s && u))
                a.checkbox = U("input", { type: "checkbox", checked: a.selected, defaultChecked: a.selected },
                    e.itemCheckboxStyle, c.container), J(a.checkbox, "click", function(b) { G(a, "checkboxClick", { checked: b.target.checked }, function() { a.select(); }); });
            d = n.getBBox();
        ...
        render: function() {
            ...
            Gb(e, function(a, b) { return (a.options && a.options.legendIndex || 0) - (b.options && b.options.legendIndex || 0); });
        ...
        handleOverflow: function(a) {
            ...
            if (a > f && !e.useHTML) {
                ...
                h.attr({ height: c });
                if (!m)
                    this.nav = m = d.g().attr({ zIndex: 1 }).add(this.group), this.up = d.symbol("triangle", 0, 0, k, k).on("click", function() { b.scroll(-1, j); }).add(m), this.pager = d.text("", 15, 10).css(i.style).add(m), this.down = d.symbol("triangle-down",
                        0, 0, k, k).on("click", function() { b.scroll(1, j); }).add(m);
                b.scroll(0);
                a = f;
        ...
        scroll: function(a, b) {
            ...
            d > c && (d = c);
            if (d > 0)
                b !== w && Ha(b, this.chart), this.nav.attr({ translateX: i, translateY: e + 7 + this.titleHeight, visibility: "visible" }), this.up.attr({
                    fill: d ===
                        1 ? h : g
    ...
    sb.prototype = {
        init: function(a, b) {
            ...
            f.index = Aa.length;
            Aa.push(f);
            d.reflow !== !1 && J(f, "load", function() { f.initReflow(); });
        ...
        redraw: function(a) {
            ...
            if (this.hasCartesianSeries) {
                ...
                this.getMargins();
                n(b, function(a) {
                    if (a.isDirtyExtremes) a.isDirtyExtremes = !1, l.push(function() { G(a, "afterSetExtremes", a.getExtremes()); });
        ...
        hideLoading: function() {
            ...
            b && vb(b, { opacity: 0 }, { duration: a.loading.hideDuration || 100, complete: function() { M(b, { display: O }); } });
            this.loadingShown = !1;
        },
        get: function(a) {
        ...
        getAxes: function() {
            ...
            c = c.concat(b);
            n(c, function(b) { new ab(a, b); });
            a.adjustTickAmounts();
        },
        getSelectedPoints: function() {
            var a = [];
            n(this.series, function(b) { a = a.concat(Ob(b.points, function(a) { return a.selected; })); });
            return a;
        },
        ...
        zoomOut: function() {
            var a = this;
            G(a, "selection", { resetSelection: !0 }, function() { a.zoom(); });
        },
        zoom: function(a) {
            var b, c = this.pointer, d = !1, e;
            !a || a.resetSelection ?
                n(this.axes, function(a) { b = a.zoom(); }) : n(a.xAxis.concat(a.yAxis), function(a) {
        ...
        initReflow: function() {
            ...
            J(E, "resize", a);
            J(b, "destroy", function() { ba(E, "resize", a); });
        },
        setSize: function(a, b, c) {
            var d = this, e, f, g;
            d.isResizing += 1;
            g = function() { d && G(d, "endResize", null, function() { d.isResizing -= 1; }); };
            Ha(c, d);
        ...
        isReadyToRender: function() {
            var a =
                this;
            return !Z && E == E.top && z.readyState !== "complete" || $ && !E.canvg ? ($ ? Qb.push(function() { a.firstRender(); }, a.options.global.canvasToolsURL) : z.attachEvent("onreadystatechange", function() {
        ...
        firstRender: function() {
            ...
            if (a.isReadyToRender())
                a.getContainer(), G(a, "init"), a.resetMargins(), a.setChartSize(), a.propFromSeries(), a.getAxes(), n(b.series || [], function(b) { a.initSeries(b); }),
    ...
    S.prototype = {
        ...
        init: function(a, b) {
            ...
            e.push(this);
            this._i = e.length - 1;
            Gb(e, function(a, b) { return o(a.options.index, a._i) - o(b.options.index, a._i); });
            n(e, function(a, b) {
                a.index = b;
        ...
        getSymbol: function() {
            ...
            if (!this.symbol)
                s(a._symbolIndex) ? a = a._symbolIndex : (a._symbolIndex = c.symbol, a = c.symbol++),
                this.symbol = d[a];
        ...
        setData: function(a, b) {
            ...
            if (l > (d.turboThreshold || 1E3)) {
                ...
                if (ua(f)) {
                    ...
                    if (p) for (i = 0; i < l; i++) d = a[i], j[i] = d[0], k[i] = d.slice(1, p + 1);
        ...
        remove: function(a, b) {
            ...
            if (!c.isRemoving)
                c.isRemoving = !0, G(c, "remove", null, function() {
                    c.destroy();
        ...
        animate: function(a) {
            ...
            if (a) a = c[h], e = c[h + "m"], a || (c[h] = a = d.clipRect(u(f, { width: 0 })), c[h + "m"] = e = d.clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight)), b.group.clip(a), b.markerGroup.clip(e), b.sharedClipKey = h;
            else {
                if (a = c[h])
        ...
        drawPoints: function() {
            ...
            if (m.enabled || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g =
                        b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = m.enabled && i.enabled === w || i.enabled, l = c.isInsidePlot(d, e, c.inverted), a && e !== w && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k.attr({ visibility: l ? Z ? "inherit" : "visible" : "hidden" }).animate(u({ x: d - h, y: e - h }, k.symbolName ? { width: 2 * h, height: 2 * h } : {}));
                        else {
        ...
        getAttribs: function() {
            ...
            n(["hover",
                "select"], function(b) { j[b] = a.convertAttribs(d[b], j[""]); });
            a.pointAttr = j;
            for (g = i.length; g--;) {
                h = i[g];
        ...
        destroy: function() {
            ...
            n("area,graph,dataLabelsGroup,group,markerGroup,tracker,graphNeg,areaNeg,posClip,negClip".split(","), function(b) { a[b] && (d = c && b === "group" ? "hide" : "destroy", a[b][d]()); });
        ...
        invertGroups: function() {
            ...
            J(c, "resize", a);
            J(b, "destroy", function() { ba(c, "resize", a); });
            a();
            b.invertGroups = a;
        },
        ...
        setVisible: function(a, b) {
            ...
            c.options.stacking && n(d.series,
                function(a) { if (a.options.stacking && a.visible) a.isDirty = !0; });
        ...
        drawTracker: function() {
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.pointer, h = f.renderer,
                i = f.options.tooltip.snap, j = a.tracker, k = b.cursor, k = k && { cursor: k }, m = a.singlePoints, l, n = function() { if (f.hoverSeries !== a) a.onMouseOver(); };
    ...
    L = ea(S, {
        ...
        getSegments: function() {
            ...
            if (this.options.stacking && !this.cropped) {
                ...
                for (f in b)
                    c[f] ? a.push(c[f]) : (d = this.xAxis.translate(f),
    ...
    K = ea(S, {
        ...
        animate: function(a) {
            ...
            if (Z)
                a ? (e.scaleY = 0.001, a = F(b.pos + b.len, q(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ?
    ...
    W = {
        ...
        pointClass: ea(Ma, {
            ...
            setVisible: function(a) {
                ...
                n(["graphic", "dataLabel", "connector",
                    "shadowGroup"], function(a) { if (b[a]) b[a][e](); });
        ...
        drawDataLabels: function() {
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = o(e.connectorPadding, 10), g = o(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, j, k = o(e.softConnector,
                !0), m = e.distance, l = a.center, p = l[2] / 2, r = l[1], s = m > 0, u, v, w, x, C = [[], []], z, A, G, H, D, F = [0, 0, 0, 0], L = function(a, b) { return b.y - a.y; }, M = function(a, b) { a.sort(function(a, c) { return a.angle !== void 0 && (c.angle - a.angle) * b; }); };
            if (e.enabled || a._hasPointLabels) {
                S.prototype.drawDataLabels.apply(a);
                n(b, function(a) { a.dataLabel && C[a.half].push(a); });
                ...
                if (pa(F) === 0 || this.verifyDataLabelOverflow(F))
                    this.placeDataLabels(), s && g && n(this.points, function(b) {
                        i = b.connector;
                        w = b.labelPos;
                        if ((u = b.dataLabel) &&
                            u._pos) z = u.connX, A = u.connY, j = k ? ["M", z + (w[6] === "left" ? 5 : -5), A, "C", z, A, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", z + (w[6] === "left" ? 5 : -5), A, "L", w[2], w[3], "L", w[4], w[5]], i ? (i.animate({ d: j }), i.attr("visibility", G)) : b.connector = i = a.chart.renderer.path(j).attr({ "stroke-width": g, stroke: e.connectorColor || b.color || "#606060", visibility: G }).add(a.group);
        ...
        verifyDataLabelOverflow: function(a) {
            ...
            e < b[2] ? (b[2] = e, this.translate(b), n(this.points, function(a) { if (a.dataLabel) a.dataLabel._pos = null; }), this.drawDataLabels()) : f = !0;
            return f;
        },
